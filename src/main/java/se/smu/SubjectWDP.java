...
public class SubjectWDP extends JFrame{
	private Font f = new Font("돋움", Font.BOLD, 20);
	private Font f2 = new Font("돋움", Font.BOLD, 9);
	
	public SubjectWDP(String str1, String str2) {
		setTitle("To do list");
		...
		JButton subjectConfirm = new JButton(str2);
	...
	public static void main(String[] args) {
		//SubjectWDP subjectWDP = new SubjectWDP(str1, str2);
	}
